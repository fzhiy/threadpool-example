...
public class ThreadPoolApp {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out
                    .println("Creating a pool of " + numberOfThreads + " threads to process " + numberOfJobs + " jobs");
            ...
            pool.shutdown(); // shutdown the pool. Previously submitted tasks are executed, but no new tasks
                             // will be accepted.
    ...
    private static void error() {
        System.err.println("ThreadPoolApp must be run with two positive valued "
